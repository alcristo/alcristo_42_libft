...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/05/24 11:26:27 by alcristo          #+#    #+#              #
#    Updated: 2026/05/27 12:35:11 by alcristo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

<i>Este proyecto ha sido creado como parte del currículo de 42 por <alcristo>[Álvaro Cristóbal Olalla]</i>
...
<b>INSTRUCCIONES</b>
	...
	Para utilizar la librería en un archivo .c hay que añadir la flag -l junto con la librería.

	> [compilador] [-flags] -l libft.a [archivos.c]
